            ...
            <div className="drawer-content flex flex-col">
                ...
                <div className="p-3 pt-5 sm:p-8">
                    <div className="flex justify-between items-center mb-3 sm:mb-6">
                        <h1 className="text-2xl sm:text-[32px] font-semibold">Team</h1>
                        <div className="join">
                        ...
                        <button className="btn btn-primary text-[12px] sm:text-[14px] rounded-lg sm:py-6 btn-sm sm:btn-md">Add New Member</button>
                    </div>
                    <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-3 sm:gap-8">
                        {users.map((user, index) => (
                            <div key={index} className="flex flex-col items-center text-center bg-white bg-[url('/Pattern.png')] min-w-66 py-12 rounded-3xl">
                                <img src={user.avatar} className="w-[110px] h-[110px] mb-6 rounded-full" alt="" />
                                <h4 className="font-semibold mb-1">{user.first_name} {user.last_name}</h4>
                                <p className="text-sm text-[#202224] mb-2">Member</p>
